...
from PointNet2.data_util.ShapeNetDataloader import *
from PointNet2.segmentation.provider import *
from PointNet2.segmentation.models.Pointnet2 import *

# 传入命令行参数
sys.argv = ['--model', '--batchsize', '32','--epoch', '200', '--gpu', '5']
args = parse_args()
...
plt.plot(lr_history,color='r', label="learning rate")
plt.legend()
